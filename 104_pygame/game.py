    ...
    while True:
      for event in pygame.event.get():
        if event.type == QUIT:
          pygame.quit()
          sys.exit()
        elif event.type == pygame.MOUSEBUTTONDOWN and event.button == 1: # left button down
          bar_move_left = True
        elif event.type == pygame.MOUSEBUTTONUP and event.button == 1: # left button up
          bar_move_left = False
        elif event.type == pygame.MOUSEBUTTONDOWN and event.button == 3: # right button
          bar_move_right = True
